...
public class DeleteCommandTest {
    ...
    public void setUp() throws Exception {
        Person johnDoe = new Person(new Name("John Doe"), new Phone("61234567", false),
                new Email("john@doe.com", false), new Address("123, 395C Ben Road, #12-34, 231534", false), Collections.emptySet());
        Person janeDoe = new Person(new Name("Jane Doe"), new Phone("91234567", false),
                new Email("jane@doe.com", false), new Address("123, 33G Ohm Road, #12-34, 231534", false), Collections.emptySet());
        Person samDoe = new Person(new Name("Sam Doe"), new Phone("63345566", false),
                new Email("sam@doe.com", false), new Address("123, 55G Abc Road, #12-34, 231534", false), Collections.emptySet());
        Person davidGrant = new Person(new Name("David Grant"), new Phone("61121122", false),
                new Email("david@grant.com", false), new Address("123, 44H Define Road, #12-34, 231534", false),
    ...
    public void execute_targetPersonNotInAddressBook_returnsPersonNotFoundMessage()
        ...
        Person notInAddressBookPerson = new Person(new Name("Not In Book"), new Phone("63331444", false),
                new Email("notin@book.com", false), new Address("123, 156D Grant Road, #12-34, 231534", false), Collections.emptySet());
